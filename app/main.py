...
from subtitle_extractor import VideoSubtitleExtractor
import time
...
def main():
    ...
    # Alternative text input for full path (for debugging or custom paths)
    # custom_video_path = st.text_input(
    #     "Or enter full path to video file", 
    #     help="Use this for custom or non-mounted video files"
    # )
